...
class Load extends Client {
        ...
        try {
            ...
            backgroundTasks
                ...
                .forEach(async (task) => {
                    ...
                    if (Job.autostart) {
                        console.log(`(Autostart) : ${Job.name}`);
                        await Job.execute();
                    }
                    if (this.maxTicks < Job.tickRate) {
                        this.maxTicks = Job.tickRate;
                    }
                    console.log(`(Load Job) : ${Job.name}`);
                });
            ...
            directories.forEach(async (dir) => {
                ...
                commands
                    ...
                    .forEach(async (cmd) => {
                        ...
                        console.log(`(Load Command) : ${Command.help.name}`);
                    });
            });
    ...
    async backgroundTasks() {
        console.log("(Run) Background tasks runnung. Max tick rate: " + this.maxTicks);
